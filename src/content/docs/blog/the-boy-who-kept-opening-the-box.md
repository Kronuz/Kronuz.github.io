...
The first machine that was actually **mine** arrived a few years later, and I remember the exact shape of the moment, or most of it. It was **night** in Mexico City, the family waiting in the car while my dad went to collect something he had not explained. He came back carrying **two big boxes**. *"It's a computer,"* he said, as plainly as if he were saying *it's groceries*. I was **eleven, maybe twelve**. I had seen computers in movies and on television, but I could not believe one of those strange, almost magical things was about to be in my house, mine to take apart. That fawn-colored box spoke in **small bright green letters**, a **Hercules** monitor, glowing phosphor on black, driven by an **8088**, the **XT**-class machine I still remember by name, which we later upgraded to an **8086**. Green on black was simply what a computer looked like, to me, for years. That box is, I think, the literal first box of this whole story. I have been opening it, in one form or another, ever since.
