...
The first machine that was actually **mine** arrived a few years later, and I remember the exact shape of the moment. It was a **cold winter night** at the tail end of the **1980s**, in Mexico City, the family waiting in the car while my dad went to collect something he had not explained. He came back carrying **two big boxes**. *"It's a computer,"* he said, as plainly as if he were saying *it's groceries*. I was **eleven**. I had seen computers in movies and on television, but I could not believe one of those strange, almost magical things was about to be in my house, mine to take apart. That fawn-colored box spoke in **small bright green letters**, a **Hercules** monitor, glowing phosphor on black, driven by an **8088**, the **XT**-class machine I still remember by name, which we later upgraded to an **8086**. Green on black was simply what a computer looked like, to me, for years. That box is, I think, the literal first box of this whole story. I have been opening it, in one form or another, ever since.
...
My first real patch is still there, posted in **November 2005**, fourteen minutes after I made the account. I am still a little proud of it. The scalers, the routines that blow up a tiny old game to fit a modern screen, were redrawing the entire picture every single frame. I changed them to redraw only the parts that had actually changed. The benchmarks were almost comical: the simplest scaler got about **90% faster**, and the fanciest one, **Hq2x**, went from **10,676** down to **109** on my test, a speedup of roughly **9,500%**. I built my own custom DOSBox around the patch and served it from a machine in my own house, `ftp://kronuz.no-ip.com`, available (as I cheerfully warned everyone) "only when I'm online." I signed every post with a line I had taken as a motto: *"Time is of the essence."* I did not yet understand how completely my whole career would turn out to be about exactly that, about not wasting work, about not doing a thing until the moment you truly have to.

The reception was, at first, the part I treasured. The DOSBox regulars, the core developers among them, started naming me in the same breath as the people who actually built the thing. One of them wrote into the project's official FAQ that, on the subject of speed, *"unless miracles happen (like Kronuz video patch), don't expect much."* A miracle.

And then something happened that I have turned over in my head for years. The core team liked the ideas enough to put them into the next release, DOSBox 0.65, but they did not take my patch. They reimplemented the design in their own code. When the changelog came out, the scalers I had added were there with my name beside them, *"(Kronuz),"* but the optimization I was actually proud of, the redraw-only-what-changed idea that had started the whole thing, was in that same list reworded as *"EGA/VGA memory changes detection for faster rendering,"* with no name beside it at all. I was not in the project's thank-you file either. A teenager who had given something real to a project he loved, watching the part that mattered most get quietly reabsorbed and left unsigned. I will be honest that it stung, and that it is a good part of why I drifted away from DOSBox. Years later I would care, probably more than is reasonable, about names staying attached to work: a credit at the bottom of a PostgreSQL manual page, a project I got to *name*, an author line on a language proposal. I suspect this is where that started.
...
Then there was **Dubalu**, where I served as **CTO**. Dubalu was supposed to be a social network organized around **"circles,"** the idea that you do not share everything with everyone, that your life has groups and you want to post to one without the others. We built this. And then, months after, **Google+** launched circles to the entire world and made it look like a novel idea. There is a particular ache to being early, to holding a thing in your hands a year before it has a name everyone knows. But Dubalu also gave me **Xapiand**, a distributed search and storage engine I wrote in modern C++, async to the core, and that engine taught me more about systems at scale than anything before it.
...
I keep coming back to the symmetry of it. A locked-down night, a five-month-old asleep in the next room, an engineer annoyed at a number on a screen. And then, a few years later, that same small annoyance, *this work does not need to happen yet*, written into the grammar of a language that millions of people reach for every day. Not because I was the smartest person in the room. I was almost never the smartest person in the room. Because I could not leave the box closed.

From a borrowed Commodore 64 in 1980s Mexico City to a word you can type in the Python grammar. Written out, the middle looks like a dozen different people: a virus-writing teenager, an emulation hobbyist, a failed Amazon-killer, a name sitting quietly at the bottom of a PostgreSQL manual page, a search-engine author, a CTO, an infrastructure engineer.

It was only ever one person. A boy who could not look at a closed box without needing to know how it worked, who was perfectly willing to break it to find out, and who got improbably lucky, because the world turned out to be made of boxes, each one bigger than the last. A modem. A game console. A game engine. A database. A language. The boxes kept changing. The boy doing the prying never did.

And none of the big ones opened alone. Victor put C and a Commodore 64 in front of a restless cousin. My father walked in out of a cold winter night with two boxes and never once asked what I planned to do with them. Carl Meyer and Dino Viehland climbed down into the dictionary internals with me without flinching; Pablo Galindo Salgado and a roomful of people I deeply admire carried the second attempt across the line the language had drawn; and more teams than I can fit here, at Instagram, on Cinder, across Python infrastructure, handed a relentlessly curious engineer the most dangerous parts of the machine and trusted him not to break them. My wife and my daughter turned the hardest, most locked-down years of my life into the ones I would not trade away. You do not open the biggest boxes by yourself. I know exactly whose hands were on each one alongside mine.

The cursor still blinks. It still does not care about me, and after all these years I still care more precisely because of that. And I can feel the next boxes out there, the bigger ones, sitting just off the edge of the frame the way the good stuff always does. I have no intention of stopping.

This was only the throughline, the honest shape of it. The other stories, the ones I left on the floor to keep this one moving, could fill a small book, and maybe one day they will. For now, this is enough: a life measured in machines, and the same restless boy at the seam of every one, prying, listening for the exact moment it gives.
