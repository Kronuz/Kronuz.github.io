...
The reception is the part I still treasure. The DOSBox regulars, the core developers among them, started naming me in the same breath as the people who actually built the thing. One of them wrote into the project's official FAQ that, on the subject of speed, *"unless miracles happen (like Kronuz video patch), don't expect much."* A miracle. And then the best possible fate befell my patch: the core team liked the ideas enough to fold them straight into the next release, after which, as another regular happily reported, *"performance is very comparable to the Kronuz patch now,"* and my patch was no longer needed at all. Made obsolete by having your own contribution absorbed into the real thing. I cannot think of a better way for a patch to die.
